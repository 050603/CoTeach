...
export function withoutPrivatePackageContent<T extends object>(content: T): T {
  ...
  for (const key of ["resourcePackage", "textbookSelections", "courseEvidence", "teachingRequirements", "teachingBlueprint", "teachingTimingAudit", "teachingAdoptions", "teachingRevisionState", "designWorkspaceRevision", "designGenerationTrace", "teacherReviewItems", "teacherReviewSummary", "teacherReviewVersion", "knowledgeScopePlan", "teacherReview", "renderReview", "qualityReview", "qualityReviewRequired"]) delete copy[key];
