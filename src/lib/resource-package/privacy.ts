...
export function withoutPrivatePackageContent<T extends object>(content: T): T {
  ...
  for (const key of ["resourcePackage", "teachingBlueprint", "teachingTimingAudit", "designGenerationTrace", "teacherReview", "renderReview", "qualityReview", "qualityReviewRequired"]) delete copy[key];
  return copy;
}
