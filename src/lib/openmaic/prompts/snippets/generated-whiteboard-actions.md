...
- Geometry is checked after generation. If feedback lists overlaps, out-of-bounds elements, unresolved anchors or invalid data/formulas, correct those exact issues while preserving the requested teaching content and narration.
