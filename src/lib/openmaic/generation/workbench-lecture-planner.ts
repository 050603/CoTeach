...
- Plan no quiz pages. CoTeach adds the selected section check after each confirmed section: by default 2–4 lightweight objective/fill items, or one synthesis response only when deep response is explicitly enabled.
