...
export const TTS_PROVIDERS: Record<BuiltInTTSProviderId, TTSProviderConfig> = {
  ...
  'qwen-tts': {
    id: 'qwen-tts',
    name: 'Qwen Audio 3.0 TTS（阿里云百炼）',
    requiresApiKey: true,
    maxConcurrency: 2,
    defaultBaseUrl: 'https://dashscope.aliyuncs.com/api/v1',
    icon: '/logos/bailian.svg',
    models: QWEN_AUDIO_TTS_MODELS.map((model) => ({ ...model })),
    defaultModelId: DEFAULT_QWEN_AUDIO_TTS_MODEL_ID,
    voices: QWEN_AUDIO_TTS_VOICES,
    supportedFormats: ['mp3', 'wav', 'pcm', 'opus'],
    speedRange: { min: 0.5, max: 2.0, default: 1.0 },
  },
  'minimax-tts': {
    id: 'minimax-tts',
...
export const DEFAULT_TTS_VOICES: Record<BuiltInTTSProviderId, string> = {
  ...
  'glm-tts': 'tongtong',
  'qwen-tts': DEFAULT_QWEN_AUDIO_TTS_VOICE,
...
export const DEFAULT_TTS_MODELS: Record<BuiltInTTSProviderId, string> = {
  ...
  'azure-tts': '',
  'glm-tts': 'glm-tts',
  'qwen-tts': DEFAULT_QWEN_AUDIO_TTS_MODEL_ID,
