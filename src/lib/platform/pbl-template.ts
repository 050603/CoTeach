...
const contentFields = ["pblOutline", "teacherRequiredKnowledgePoints", "knowledgePoints", "knowledgeGraph", "projectMainline", "teachingOutline", "lessonOutline", "knowledgeLectureSections", "evaluationPlan", "_openmaicClassroomId", "_openmaicScenesCount", "_openmaicSceneOutlines", "moduleTimingPlan", "teacherResources", "teacherClassroomId", "adaptiveLearningPlan", "designGenerationTrace"] as const;
