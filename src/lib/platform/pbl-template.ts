...
const contentFields = ["resourcePackage", "textbookSelections", "courseEvidence", "stagePlan", "teachingRequirements", "qualityReviewRequired", "qualityReview", "renderReview", "teacherReview", "teacherReviewItems", "teacherReviewSummary", "teacherReviewVersion", "classroomGenerationRun", "pblOutline", "teacherRequiredKnowledgePoints", "knowledgeScopePlan", "knowledgePoints", "knowledgeGroups", "knowledgeGraph", "teachingBlueprint", "teachingTimingAudit", "teachingRevisionState", "designWorkspaceRevision", "projectMainline", "teachingOutline", "lessonOutline", "knowledgeLectureSections", "evaluationPlan", "_openmaicClassroomId", "_openmaicScenesCount", "_openmaicSceneOutlines", "moduleTimingPlan", "teacherResources", "teacherClassroomId", "adaptiveLearningPlan", "designGenerationTrace"] as const;
