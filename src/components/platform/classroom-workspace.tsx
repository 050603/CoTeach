...
export function ClassroomWorkspace({ participationId, role = "student", returnHref }: { participationId: string; role?: "teacher" | "student"; returnHref?: string }) {
