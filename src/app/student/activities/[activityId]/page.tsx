...
type Activity = { id: string; type: string; title: string; description: string | null; isOpen: boolean; offering: { id: string; name: string; status: string }; chapter: { title: string }; config?: { content?: string; url?: string; resourceKind?: "link" | "file"; fileName?: string; questions?: SurveyQuestion[] }; progress: { status: string; progressData?: { answer?: string; answers?: Record<string, SurveyAnswer> } }; instance: ActivityInstance | null; instances?: ActivityInstance[] };
